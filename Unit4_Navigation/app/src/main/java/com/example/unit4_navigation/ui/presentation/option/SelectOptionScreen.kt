package com.example.unit4_navigation.ui.presentation.option
...
import com.example.unit4_navigation.ui.components.FormattedPriceLabel
...
fun SelectOptionPreview() {
    Unit4_NavigationTheme(darkTheme = true) {
        SelectOptionScreen(
            subtotal = "299.99",
